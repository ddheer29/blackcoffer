...
import DiscoverScreenCard from '../components/DiscoverScreenCard';
      ...
      <View>
        <FlatList
          ...
          renderItem={({ item, index }) => {
            return (
              <DiscoverScreenCard item={item} index={index} />
            )
          }}
          keyExtractor={(item, index) => index.toString()}
          contentContainerStyle={{ paddingTop: 20, paddingBottom: 340 }}
        />
      </View>
    </View>
  )
